...
namespace Carer.Repository
{
    ...
    {
        private String connectionString = "Data Source=SQL8003.site4now.net;Initial Catalog=db_a89673_childdb;User Id=db_a89673_childdb_admin;Password=Micamaca12";
        ...
        {
            SqlConnection connection = new SqlConnection(connectionString);
            string queryString = $"UPDATE Ad SET Description = '{ad.Description}',PetId ='{ad.PetId}',Active = {ad.Active} where Id = '{ad.Id}'";
            SqlCommand command = new SqlCommand(queryString, connection);
            connection.Open();
            await command.ExecuteNonQueryAsync();
            connection.Close();
